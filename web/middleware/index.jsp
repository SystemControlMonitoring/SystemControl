<%-- 
    Document   : middleware/index.jsp
    Created on : 14.10.2013, 13:54:22
    Author     : sbaresel
--%>
...
<html>
	...
	<title>Middleware - kVASy&reg; System Control</title>
	...
	<script type="text/javascript" src="../script/jquery.searchFilter.js"></script>
        ...
        <!-- AllDatabases -->
        <script type="text/javascript" src="js/kSCmw.js"></script>
	...
	<![endif]-->
        ...
        <link rel='stylesheet' href='css/kSCmw.css' />
	<link rel='stylesheet' href='../layout/searchFilter.css' />        
        ...
        $(function() {
            $(document).ready(function() {
                ...
                AllMWs(<% out.println("'" + request.getRemoteUser() + "'"); %>);
                SubBase();
