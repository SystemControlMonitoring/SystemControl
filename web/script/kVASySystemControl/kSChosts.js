                ...
                success: function(json) {
                    ...
                    $.each(json, function() {
                        ...
                        $.each(this.HOSTS, function() {
                            ...
                            if (this.ACK == "1") { $('#' + hostcount + 'HostStatus').append('<img id="ImgHostAck" src="layout/images/icons/eye.png" title="Host Problem ist bearbeitet." />'); }
                            if (this.CMT == "") { /**/ } else { $('#' + hostcount + 'HostStatus').append('<img id="ImgHostCmt" src="layout/images/icons/balloon-left.png" title="Host wurde kommentiert." />'); }
                            hostcount++;
                        });
                    });
                    if (hostcount == 0) {
