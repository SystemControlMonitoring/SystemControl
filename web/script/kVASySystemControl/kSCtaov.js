...
function SlimTaov(uid) {
    ...
    $.ajax({
        ...
        success: function(json) {
            ...
            $('#Nodes').append('<span style="float: left;"><table cellpadding=0 cellspacing=0 border=0><tr><td colspan=3><span style="float: left;">Datenbanken</span><span style="float: left; margin-top: -1px;" class="ui-icon ui-icon-triangle-1-s"></span></td></tr><tr valign=middle><td class="default" title="Gesamt Online.">' + DB_OK_ALL + '</td><td class="' + dbocolor + '" title="Auf ONLINE Hosts."><b><a href="./db.jsp?s=YW8=KdhU7Z">' + DB_OK + '</a></b> Online</td><td class="default" title="Gesamt Offline.">' + DB_CR_ALL + '</td><td class="' + dbccolor + '"><b><a href="./db.jsp?s=YXBuYW9oKdhU7Z">' + DB_CR_NA + '</a></b> | <b><a href="./db.jsp?s=YXBhb2g=KdhU7Z">' + DB_CR_A + '</a></b> | <b><a href="./db.jsp?s=YXBkaA==KdhU7Z">' + DB_CR_NA_OFF + '</a></b> Offline</td></tr></table></span>');
