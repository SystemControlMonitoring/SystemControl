...
function SlimTaov(uid) {
    ...
    $.ajax({
        ...
        success: function(json) {
            ...
            $('#Nodes').append('<span style="float: left;"><table cellpadding=0 cellspacing=0 border=0><tr><td colspan=3><span style="float: left;">Hosts</span><span style="float: left; margin-top: -1px;" class="ui-icon ui-icon-triangle-1-s"></span><span class="Notice" style="float: right;">' + cnodet + '</span></td></tr><tr valign=middle><td class="' + ocolor + '"><b><a href="/' + suburl + '/hosts.jsp?s=dXA=KdhU7Z">' + HOST_OK + '</a></b> Ok</td><td class="' + ccolor + '"><b><a href="/' + suburl + '/hosts.jsp?s=ZG9ub2Fjaw==KdhU7Z">' + HOST_CR_NA + '</a></b> | <b><a href="/' + suburl + '/hosts.jsp?s=ZG9hY2s=KdhU7Z">' + HOST_CR_A + '</a></b> Offline</td><td class="' + ucolor + '"><b><a href="/' + suburl + '/hosts.jsp?s=dW5ub2Fjaw==KdhU7Z">' + HOST_UN_NA + '</a></b> | <b><a href="/' + suburl + '/hosts.jsp?s=dW5hY2s=KdhU7Z">' + HOST_UN_A + '</a></b> Nicht Erreichbar</td></tr></table></span>');
