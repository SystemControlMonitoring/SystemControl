...
function Liveticker(uid) {
    ...
    $.ajax({
        url: 'http://172.23.10.249:6560/proxy/json/?e=1&t=1&cm=bGRhHj7Kl9&m=RmlsbExpdmV0aWNrZXI=RpY2Fs&u=' + b64uid + 'LKHld3',
        crossDomain: true,
        success: function() {
                $.ajax({
                    url: 'http://172.23.10.249:6560/proxy/json/?e=1&cm=bGRhHj7Kl9&m=U2VsZWN0TGl2ZXRpY2tlcg==RpKlFs&u=' + b64uid + 'LKHld3',
                    crossDomain: true,
